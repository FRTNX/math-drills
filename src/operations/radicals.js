...
var radicals = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, numberOfTerms, terms, formattedTerms, i, root, index, radicand, questionLatex, correctAnswer, operator, options, result, question, existingQuestion, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                for (i = 0; i < numberOfTerms; i++) {
                    root = random.apply(void 0, __spreadArray([], __read(difficultyProfile.rootRange), false));
                    index = difficultyProfile.indices[random(0, difficultyProfile.indices.length)];
                    radicand = Math.pow(root, index);
                    index === 2
