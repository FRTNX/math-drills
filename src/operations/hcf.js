...
var hcf = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, numberOfTerms, terms, primes, i, numberOfPrimes, primeIndices, i_1, primeIndex, selectedPrimes, product_1, primeArrayDetails, i, _a, _b, prime, commonFactors, checkOccurances, product, factors, questionLatex, question, existingQuestion, error_1;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                ;
                commonFactors = {};
                checkOccurances = function (array, element) {
                    var e_2, _a;
                    var counter = 0;
                    try {
                ...
                Object.keys(primeArrayDetails).map(function (arrayIndex) {
                    Object.keys(primeArrayDetails[arrayIndex]).map(function (prime) {
                        var currentOccurance = primeArrayDetails[arrayIndex][prime];
                        if (primes.every(function (primeArray) { return checkOccurances(primeArray, prime) >= currentOccurance; })) {
                ...
                if (Object.keys(commonFactors).length > 0) {
                    factors = Object.keys(commonFactors).map(function (prime) { return Math.pow(Number(prime), commonFactors[prime]); });
