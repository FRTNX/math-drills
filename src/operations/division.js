...
var division = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, quotient, divisor, dividend, styles, style, questionLatex, formattedTerms, question, existingQuestion, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                difficultyProfile = DIFFICULTY_PROFILES[difficulty];
                quotient = random.apply(void 0, __spreadArray([], __read(difficultyProfile.quotientRange), false));
                divisor = random.apply(void 0, __spreadArray([], __read(difficultyProfile.divisorRange), false));
                dividend = quotient * divisor;
                styles = ['default', 'fraction'];
                style = styles[random(0, styles.length)];
                questionLatex = '';
                if (style == 'default') {
                    formattedTerms = [dividend, divisor].map(function (term) { return term < 0
