...
var primeFactorization = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, primes, primeIndices, numberOfPrimes, i, primeIndex, selectedPrimes, product, questionLatex, question, existingQuestion, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                difficultyProfile = DIFFICULTY_PROFILES[difficulty];
                primes = difficultyProfile.primes;
                primeIndices = [];
                numberOfPrimes = random.apply(void 0, __spreadArray([], __read(difficultyProfile.numberOfPrimes), false));
                for (i = 0; i < numberOfPrimes; i++) {
                    primeIndex = random(0, primes.length);
                    primeIndices.push(primeIndex);
                }
                ;
                selectedPrimes = primeIndices.map(function (index) { return primes[index]; });
                product = selectedPrimes.reduce(function (prod, partProd) { return prod * partProd; }, 1);
                questionLatex = "" + product;
