...
var trinomialSquares = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, binomialTerms, trinomialTerms, _loop_1, i, numeralFactors, literalFactors, product, literalProduct, midTerm, operators, questionLatex, correctAnswer, question, existingQuestion;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                operators = ['+', '-'];
                questionLatex = trinomialTerms[0] + " " + operators[random(0, operators.length)] + " " +
