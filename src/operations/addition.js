...
var addition = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, addends, numberOfTerms, i, addend, sum, questionLatex, question, existingQuestion, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                for (i = 0; i < numberOfTerms; i++) {
                    addend = random.apply(void 0, __spreadArray([], __read(difficultyProfile.range), false));
                    addends.push(addend);
                }
                sum = addends.reduce(function (sum, value) { return sum + value; }, 0);
                questionLatex = addends.slice(1).reduce(function (latex, value) {
                    return latex + ' + ' + (value < 0 ? "(" + value + ")" : value);
                }, "" + addends[0]);
