...
var logarithm = function (operation, difficulty) { return __awaiter(void 0, void 0, void 0, function () {
    var difficultyProfile, base, exponent, result, questionLatex, question, existingQuestion, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                difficultyProfile = DIFFICULTY_PROFILES[difficulty];
                base = random.apply(void 0, __spreadArray([], __read(difficultyProfile.logBaseRange), false));
                exponent = random.apply(void 0, __spreadArray([], __read(difficultyProfile.exponentRange), false));
                result = Math.pow(base, exponent);
                questionLatex = "\\log_{" + base + "} " + result;
