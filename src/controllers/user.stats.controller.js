...
var fetchRatingProfile = function (userRatings, activeOperation) {
    if (!activeOperation) {
...
var fetchRatingHistory = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var query, limit, userAnswers, isActiveOp, userRating, ratingProfile, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                ratingProfile = fetchRatingProfile(userRating, isActiveOp);
                result = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    growth = ratingValues.length > 1
                                        ? calculateGrowth.apply(void 0, __spreadArray([], __read(ratingValues.reverse().slice(ratingValues.length - 2)), false)) : 0;
                                    highestRating = Math.max.apply(Math, __spreadArray([], __read(ratingValues), false));
                                    lowestRating = Math.min.apply(Math, __spreadArray([], __read(ratingValues), false));
            ...
            case 4:
                ...
                bestOp_1 = { questionType: '', highestRating: 0 };
...
var fetchOpGraphData = function (userId, questionType) { return __awaiter(void 0, void 0, void 0, function () {
    var query, questionRatings, isActiveOp, ratingValues, ratingProfile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = {
            ...
            case 2:
                ...
                ratingProfile = fetchRatingProfile(ratingValues, isActiveOp);
                return [2 /*return*/, {
...
var fetchOpStats = function (userId, questionType) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_c.sent(), 5]), totalCorrectAnswers = _a[0], totalIncorrectAnswers = _a[1], answerDetails = _a[2], abortedQuestions = _a[3], graphData = _a[4];
                ...
                growth = ratingValues.length > 1
                    ? calculateGrowth.apply(void 0, __spreadArray([], __read(ratingValues.reverse().slice(ratingValues.length - 2)), false)) + "%"
                    : 'N/A';
                highestRating = Math.max.apply(Math, __spreadArray([], __read(ratingValues), false));
                lowestRating = Math.min.apply(Math, __spreadArray([], __read(ratingValues), false));
                return [4 /*yield*/, Promise.all([
            ...
            case 2:
                _b = __read.apply(void 0, [_c.sent(), 2]), correctAnswerStreak = _b[0], wrongAnswerStreak = _b[1];
                return [2 /*return*/, {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                selectedTypes.push.apply(selectedTypes, __spreadArray([], __read(answeredQuestionTypes.slice(0, 2)), false));
                _a.label = 3;
